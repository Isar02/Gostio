...
// The only file in this client that imports the hub package.
    ...
    required String? Function() token,
           ...
           .withUrl(
             ...
             options: HttpConnectionOptions(
               // A socket handshake carries no headers, so the token goes in
               // the query string, which is the one path the API reads it from.
