...
internal static class EngagementSeed
{
        ...
        DateTime now)
    {
        ...
        // The last lines a thread leaves unread for the account that opened it,
        // so a seeded inbox has something waiting in it rather than only a
        // history somebody has already been through.
        Conversation Thread(
            ...
            var conversation = new Conversation
            {
                ...
                [
                    new ConversationParticipant
                    {
                        ...
                        JoinedAt = opened,
                        LastReadAt =
                            opened.AddMinutes((lines.Length - unreadForFirst) * 7),
                    },
                    new ConversationParticipant
                    {
                        User = second,
        ...
        // about a booking still ahead of it with the host's last answer waiting,
        // one enquiry about a place it has kept, and one question to support.
        yield return AboutBooking(
